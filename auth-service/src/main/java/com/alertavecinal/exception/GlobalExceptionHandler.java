...
public class GlobalExceptionHandler {
    ...
    public GenericResponseDto<Void> handleResourceNotFoundException(ResourceNotFoundException e) {
    ...
    public ResponseEntity<GenericResponseDto<Void>> handleRuntimeException(RuntimeException e) {
        ErrorMessage error = ErrorMessage.builder()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .message(e.getMessage())
                .dateError(LocalDate.now())
                .build();
        GenericResponseDto<Void> response = GenericResponseDto.<Void>builder()
                .error(error)
                .build();
